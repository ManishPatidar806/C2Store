      ...
      <div className="bg-primary-600">
        <div className="container-wide py-12">
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-heading-2 text-white mb-4">Stay In Style</h3>
            <p className="text-primary-100 mb-8">
              Subscribe to our newsletter for the latest fashion trends, exclusive offers, and style inspiration.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              />
              <button className="px-6 py-3 bg-white text-primary-600 font-medium rounded-xl hover:bg-primary-50 transition-colors duration-200">
                Subscribe
              </button>
            </div>
          </div>
            ...
            <div className="flex items-center space-x-6">
              ...
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 bg-neutral-800 hover:bg-primary-600 rounded-lg flex items-center justify-center text-neutral-400 hover:text-white transition-all duration-200 transform hover:scale-110"
